...
function renderFormation(name) {
  ...
  formation.forEach(function(pos) {
...
function renderPlayers(data) {
  ...
  filtered.forEach(function(p) {
    ...
    div.onclick = function() {
      ...
      currentSlot.setAttribute("data-id", p.id);
...
function applyFilters() {
  ...
  if (filterSelect.value !== "") {
    data = data.filter(function(p) {
      ...
      if (filterSelect.value === "GK") return pos === "GK";
      if (filterSelect.value === "DEF") return ["CB","LB","RB"].includes(pos);
      if (filterSelect.value === "MID") return ["CM","CDM","CAM"].includes(pos);
      if (filterSelect.value === "ATT") return ["ST","LW","RW"].includes(pos);
    });
  }
